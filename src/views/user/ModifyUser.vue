<template>
    <div>
        <BreadCrumb class="bread" :breads="['用户','用户管理','添加用户']"></BreadCrumb>
        <div class="wrap">
            <div class="header">
                <span class="nameFt">添加用户</span>
                                ...
                                <el-form-item label="真实姓名" prop="rel_name">
                                 ...
                                 <el-form-item label="确认密码" prop="checkPass">
                                  <span > <el-input  placeholder="确认密码" type="password" v-model="ruleForm.checkPass"> </el-input></span>
                                      ...
                                      <el-form-item label="是否禁用" props="status">
<el-radio v-model="ruleForm.status" label="NORMOL">正常</el-radio>
...
<el-form-item label="是否为补货员" props="replenish">
<el-radio v-model="ruleForm.replenish" label="YES">是</el-radio>
<el-radio v-model="ruleForm.replenish" label="NO">否</el-radio>
</el-form-item>
  ...
  data() {
     ...
     var validateusername = (rule, value, callback) => {
            ...
            if (!value) {
                ...
                if (!reg.test(value)) {
                    callback(new Error('登陆账号为3-20个英文或数字或下划线'));
                } else {
                    callback()
                }
            }
